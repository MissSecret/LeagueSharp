    ...
    * */
    ...
    internal class Karthus
    {
        ...
        public Karthus()
        {
            ...
            _menu.AddItem( new MenuItem("HitChanceQ", "HitChanceQ").SetValue( new StringList( new [] {"Low", "Medium", "High", "Very High"} ) ) );
        ...
        bool Combo()
        {
            ...
            if (_menu.Item("comboQ").GetValue<bool>() && _spellQ.IsReady())
            {
                ...
                {
                    anyQTarget = true;
                    _spellQ.CastIfHitchanceEquals(target, HitChanceQ(), true);
                }
            }
        ...
        void Harass()
        {
            ...
            if (_menu.Item("harassQ").GetValue<bool>())
                _spellQ.CastIfHitchanceEquals(TargetSelector.GetTarget(_spellQ.Range, TargetSelector.DamageType.Magical), HitChanceQ(), true);
        }
        ...
        HitChance HitChanceQ()
        {
            var HitChanceQ = _menu.Item("HitChanceQ").GetValue<StringList>().SelectedValue;
            if (HitChanceQ == "Low") { return HitChance.Low; }
            else if (HitChanceQ == "Medium") { return HitChance.Medium; }
            else if (HitChanceQ == "High") { return HitChance.High; }
            else if (HitChanceQ == "Very High") { return HitChance.VeryHigh; }
